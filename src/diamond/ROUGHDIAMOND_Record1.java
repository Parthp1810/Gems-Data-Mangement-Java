...
public class ROUGHDIAMOND_Record1 extends javax.swing.JFrame {
...
private void Reset()
{
    ...
    private void initComponents() {
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(13, 62, 1130, 430));
        ...
        jPanel1.add(KAPAN, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 20, 210, -1));
    ...
    private void GetDataActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GetDataActionPerformed
        ...
        try
        {
            ...
            String sql= "select sum(ROUGHW),sum(DOLLAR) from ROUGHDIAMOND where KAPAN= '" + KAPAN.getText() + "'";
        ...
        try 
        {
            ...
            {
                Connection con=Connect.ConnectDB();
                String sql = "select * from ROUGHDIAMOND order by KAPAN,PACKET,SUBPACKET";
                Statement st = con.createStatement();
                ResultSet rs = st.executeQuery(sql);
                DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
                while (rs.next()) 
            ...
            else
            {
                ...
                String sql1 = "Select KAPAN from ROUGHDIAMOND where Kapan = '" + KAPAN.getText() + "'";
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        try 
        {
            ...
            Connection con=Connect.ConnectDB();
            String sql = "select * from ROUGHDIAMOND where KAPAN='"+table_click2+"' AND SUBPACKET='"+table_click1+"' AND PACKET = '" + table_click + "'";
...
public void toExcel(JTable table)
{
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ROUGHDIAMOND_Record1().setVisible(true);
            }
        });
    }
