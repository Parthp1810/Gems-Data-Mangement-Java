...
public class POLISHREPORT_Record extends javax.swing.JFrame {
...
private void Refresh()
{
    ...
    private void initComponents() {
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(13, 14, 1130, 467));
    ...
    private void GetDataActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GetDataActionPerformed
        try
        {
            ...
            String sql= "select SUM(DOLLAR) from POLISHREPORT where PACKET !=0 order by PACKET";
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        try 
        {
            ...
            Connection con=Connect.ConnectDB();
            String sql = "select * from polishreport where  SUBPACKET='"+table_click1+"' AND  PACKET ='" + table_click + "'";
 ...
 GetData.doClick();        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new POLISHREPORT_Record().setVisible(true);
            }
        });
    }
