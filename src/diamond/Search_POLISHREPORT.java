...
public class Search_POLISHREPORT extends javax.swing.JFrame {
...
public void Reset(){
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "DATE", "KAPAN NO.", "PACKET NO.", "SUB PACKET", "POLISH WEIGHT", "COLOUR", "CLEARITY", "SHAPE", "FLURESCENCE", "CUT", "SYMMETRY", "POLISH", "MEASUREMENT", "LAB", "REPORT", "LIST", "PRICE", "TOTAL", "DEPTH %", "TABLE %", "GIRDLE THIN", "GIRDLE THICK", "GIRDLE %", "GIRDLE CONDITION", "CULET SIZE", "CULET CONDITION"
            }
        ) {
    ...
    private void SearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SearchActionPerformed
        ...
        try 
        {
            ...
            else
            {
                ...
                String sql1 = "Select KAPAN,PACKET from POLISHREPORT where Kapan = '" + KAPAN.getText() + "' and PACKET = '" + PACKET.getText() + "'";
                ...
                if (rs1.next()) 
                {
                    ...
                    {
                        String sql = "select * from POLISHREPORT where KAPAN= '" + KAPAN.getText() + "' AND  PACKET ='" + PACKET.getText() + "' order by KAPAN,PACKET,SUBPACKET";
                        Statement st = con.createStatement();
                        ResultSet rs = st.executeQuery(sql);
                        DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
                        while (rs.next()) 
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        try 
        {
            ...
            Connection con=Connect.ConnectDB();
            String sql = "select * from polishreport where KAPAN='"+table_click1+"' AND PACKET = '" + table_click + "'";
...
public void toExcel(JTable table)
{
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Search_POLISHREPORT().setVisible(true);
            }
        });
    }
