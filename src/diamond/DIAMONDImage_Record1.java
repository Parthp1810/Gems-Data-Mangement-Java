...
public class DIAMONDImage_Record1 extends javax.swing.JFrame {
...
private void updateRowHeights()
{
    ...
    private void initComponents() {
        ...
        jPanel1.add(KAPAN, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 20, 210, -1));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(13, 54, 1130, 470));
    ...
    private void GetDataActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GetDataActionPerformed
        ...
        try
        {
            ...
            else
            {
                ...
                String sql1 = "Select KAPAN from DiamondImage where Kapan = '" + KAPAN.getText() + "'";
 ...
 GetData.doClick();        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DIAMONDImage_Record1().setVisible(true);
            }
        });
    }
